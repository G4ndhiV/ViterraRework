    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8">
        <div className={cn("grid gap-12", pl.gridCols("grid-cols-1 md:grid-cols-2 lg:grid-cols-4"))}>
          <PreviewSectionChrome blockId="footer-brand" label="Marca" hideLabel>
            <div>
          ...
          <PreviewSectionChrome blockId="footer-quick" label="Enlaces rápidos" hideLabel>
            <div>
              ...
              <ul className="space-y-3 text-sm">
                {f.quickLinks.map((link, i) => (
                  <li key={`quick-${i}-${link.label}`}>
                    <PreviewFieldPulse blockId="footer-quick" fieldKey={`footer-quick-${i}-label`}>
          ...
          <PreviewSectionChrome blockId="footer-services" label="Servicios" hideLabel>
            <div>
              ...
              <ul className="space-y-3 text-sm">
                {serviceLinks.map((link, i) => (
                  <li key={`svc-${i}-${link.href}-${link.label}`}>
                    <PreviewFieldPulse blockId="footer-services" fieldKey={`footer-services-${i}-label`}>
                      <FooterNavItem link={link} />
                    </PreviewFieldPulse>
                  </li>
                ))}
          ...
          <PreviewSectionChrome blockId="footer-contact" label="Contacto" hideLabel>
            <div>
        ...
        <PreviewSectionChrome blockId="footer-legal" label="Copyright" hideLabel>
